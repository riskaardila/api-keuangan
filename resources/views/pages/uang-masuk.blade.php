                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="header-title">
                                ...
                                <a href="/getUangMasuk" class="btn btn-primary"> <i
                                        class="fas fa-plus"></i>&nbsp;
                                    Tambah Uang Masuk</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="uang_masuk" class="table table-hover scroll-horizontal-vertical w-100">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Nama</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('uangmasuk.show', $row->id) }}"
                                                    ...
                                                    <a href="{{ route('uangmasuk.edit', $row->id) }}"
