                                    ...
                                    @enderror"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="tanggal_masuk"
                                                    ...
                                                    id="tanggal_masuk" required autofocus
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="harga_masuk"
                                                    class="form-control @error('harga_masuk') is-invalid @enderror"
                                                    id="harga_masuk" required autofocus
                                                    value="{{ old('harga_masuk', $data->harga_masuk) }}">
                                                @error('harga_masuk')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
